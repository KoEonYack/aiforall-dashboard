    ...
    return (
        <div>
            <div className="block-header">
                <div className="block-title">4. 프로젝트</div>
            </div>
                ...
                <div>
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="table-head-data">링크</th>
                        ...
                        <tbody class="table-head-data">
                            <tr>
                                ...
                                <td scope="col" class="table-head-data">
                                    <a href="https://piazza.com/class/k7222vwq8y61ni?cid=856">[공지] 예비보고서 작성법</a> | <a href="https://piazza.com/class/k7222vwq8y61ni?cid=857">[공지] 예비보고서 제출란</a>
                                </td>     
