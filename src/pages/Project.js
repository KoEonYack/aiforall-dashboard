                    ...
                    <table class="table table-hover">
                        ...
                        <tbody class="table-head-data">
                            <tr>
                                ...
                                <td scope="col" class="table-head-data over-due">12주차 금(11/20) 11:55 PM </td>     
                            </tr>
                            <tr>
                                <th scope="col" class="table-head-data">최종 보고서</th> 
                                <td scope="col" class="table-head-data"><a href="https://piazza.com/class/ke5chv2120x1e3?cid=897">[공지] 최종 보고서 작성법</a></td>     
                                <td scope="col" class="table-head-data"><a href="https://piazza.com/class/ke5chv2120x1e3?cid=898">[제출] 최종보고서</a></td>     
                                <td scope="col" class="table-head-data in-due">15주차 화(12/08) 11:30 AM</td>     
                            </tr>
                            {/*}
                            <tr>
