    ...
    return (
        <div>
            ...
            <div className="block-content">
                <br />
                <img src="https://github.com/KoEonYack/aiforall-dashboard/blob/master/src/img/week9.jpg?raw=true" width="40%"  className="bible-img" />
                <br/>
                <center> 
                    ...
                    <br/> 
                        ...
                        내가 주께 대하여 귀로 듣기만 하였사오나 이제는 눈으로 주를 뵈옵나이다 <br />
                        그러므로 내가 스스로 거두어들이고 티끌과 재 가운데에서 회개하나이다 <br />
                        (욥 42:4-6) <br />
                    <br/>
                    <br/>
                </center>
