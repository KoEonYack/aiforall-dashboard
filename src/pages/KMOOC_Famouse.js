    ...
    return (
        <div>
            ...
            <div className="block-header">
                    <div className="block-title"> {/*2-2.*/} 3. KMOOC 명강의 퀴즈 응시 일정</div>
            </div>
            <div className="block-content">
            <p>- <a href="https://piazza.com/class/ke5chv2120x1e3?cid=20" target="_blank">[공지] KMOOC 명강의 Part 수강법에 대해서 알려드립니다.</a>에서 응시 방법을 확인하세요!</p>
            ...
            <table class="table table-hover">
                ...
                <tbody class="table-head-data">
                    ...
                    <tr>
                        ...
                        <td scope="col" class="table-head-data"> <div class="over-due">4주차 월요일 9:30 ~ 4주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 5주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">5주차 월요일 9:30 ~ 5주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 6주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">6주차 월요일 9:30 ~ 6주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 7주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">7주차 월요일 9:30 ~ 7주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 8주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">8주차 월요일 9:30 ~ 8주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 9주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">9주차 월요일 9:30 ~ 9주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 10주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">10주차 월요일 9:30 ~ 10주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 11주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">11주차 월요일 9:30 ~ 11주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data"> KMOOC 명강의 12주차 퀴즈 </th>    
                        <td scope="col" class="table-head-data"> <div class="over-due">12주차 월요일 9:30 ~ 12주차 일요일 23:55</div> </td>    
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 퀴즈 응시 </td>
                    </tr>
                    <tr>
