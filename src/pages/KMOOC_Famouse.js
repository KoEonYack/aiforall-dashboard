    ...
    return (
        <div>
            ...
            <div className="block-header">
                    <div className="block-title">3-1. KMOOC 명강의 퀴즈 응시 일정</div>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody class="table-head-data">
                    ...
                    <tr>
                        ...
                        <td scope="col" class="table-head-data"> <div class="future-due">8주차 월요일 9:30 ~ 9주차 월요일 23:55</div></td>   
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td>  
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data">KMOOC 명강의 8주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="future-due">9주차 월요일 9:30 ~ 10주차 월요일 23:55</div></td>   
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td>  
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data">KMOOC 명강의 9주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="future-due">10주차 월요일 9:30 ~ 11주차 월요일 23:55</div></td>   
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td>  
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data">KMOOC 명강의 10주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="future-due">11주차 월요일 9:30 ~ 12주차 월요일 23:55</div></td>   
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td>  
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data">KMOOC 명강의 11주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="future-due">12주차 월요일 9:30 ~ 13주차 월요일 23:55</div></td>   
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td>  
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data">KMOOC 명강의 12주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="future-due">13주차 월요일 9:30 ~ 14주차 월요일 23:55</div></td>   
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td> 
                    </tr>
                    <tr>
                        <th scope="col" class="table-head-data">KMOOC 명강의 13주차 퀴즈</th>    
                        <td scope="col" class="table-head-data"> <div class="future-due">14주차 월요일 9:30 ~  15주차 월요일 23:55</div></td> 
                        <td scope="col" class="table-head-data"> 응시 기간 내 KMOOC에서 시험 응시 </td> 
                    </tr>
                </tbody>
            </table>
